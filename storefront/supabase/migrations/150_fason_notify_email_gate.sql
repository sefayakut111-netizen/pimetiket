-- Mig 150 (Fason P2): notify_email_on_assign gate on fn_assign_order_to_fason
-- Base: Mig 136 A7 (proof_pending SLA + outbox payload without raw token)
...
comment on function public.fn_assign_order_to_fason(text, uuid, uuid, date, text, integer) is
  'Mig 150: notify_email_on_assign=false ise outbox satırı eklenmez; token/admin dönüşü aynı.';
