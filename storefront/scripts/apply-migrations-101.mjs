#!/usr/bin/env node
/**
 * Migration 101 — proof_validating order_status enum değeri.
 * Kullanım: node scripts/apply-migrations-101.mjs [--dry-run]
 */
...
const FILES = ["101_proof_validating_status.sql"];
