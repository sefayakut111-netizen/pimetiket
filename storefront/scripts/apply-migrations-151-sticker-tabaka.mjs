#!/usr/bin/env node
/**
 * Migration 151 — tabaka özel kesim + şeffaf sticker sayfası kartları.
 * Kullanım: node scripts/apply-migrations-151-sticker-tabaka.mjs [--dry-run]
 */
...
const FILES = ["151_sticker_tabaka_ozel_seffaf.sql"];
