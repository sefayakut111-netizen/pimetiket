#!/usr/bin/env node
/**
 * Migration 107 — cutline_designs placement_json + cutline reference mm.
 * Kullanım: node scripts/apply-migrations-107.mjs [--dry-run]
 */
...
const FILES = ["107_cutline_placement.sql"];
