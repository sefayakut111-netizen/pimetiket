#!/usr/bin/env node
/**
 * Migration 124 — editor_cutline_drafts (pre-order /editor bıçak taslakları).
 * Kullanım: node scripts/apply-migrations-124.mjs [--dry-run]
 */
...
const FILES = ["124_editor_cutline_drafts.sql"];
