#!/usr/bin/env node
/**
 * Migration 125 — returns_pending_unique (sipariş başına tek pending iade).
 * Kullanım: node scripts/apply-migrations-125.mjs [--dry-run]
 */
...
const FILES = ["125_returns_pending_unique.sql"];
