#!/usr/bin/env node
/**
 * Migration 152 — sticker sayfa grubu kart sırası.
 * Kullanım: node scripts/apply-migrations-152-sticker-kart-sira.mjs [--dry-run]
 */
...
const FILES = ["152_sticker_kart_sira.sql"];
