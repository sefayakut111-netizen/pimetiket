#!/usr/bin/env node
/**
 * Migration 099 — blog_posts CMS tablosu.
 * Kullanım: node scripts/apply-migrations-099.mjs [--dry-run]
 * Sonrası: node scripts/seed-blog-posts.mjs
 */
...
const FILES = ["099_blog_posts.sql"];
