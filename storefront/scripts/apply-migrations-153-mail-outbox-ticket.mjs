#!/usr/bin/env node
/**
 * Migration 153 — mail_outbox target_type ticket.
 * Kullanım: node scripts/apply-migrations-153-mail-outbox-ticket.mjs [--dry-run]
 */
...
const FILES = ["153_mail_outbox_target_type_ticket.sql"];
