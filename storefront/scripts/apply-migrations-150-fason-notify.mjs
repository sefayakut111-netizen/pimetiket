#!/usr/bin/env node
/**
 * Migration 150 — fason notify_email_on_assign RPC gate.
 * Kullanım: node scripts/apply-migrations-150-fason-notify.mjs [--dry-run]
 */
...
const FILES = ["150_fason_notify_email_gate.sql"];
