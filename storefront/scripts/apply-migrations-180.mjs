#!/usr/bin/env node
/**
 * Migration 180 — order transition infrastructure
 * Kullanım: node scripts/apply-migrations-180.mjs [--dry-run]
 */
...
const FILES = ["180_order_transition_infrastructure.sql"];
