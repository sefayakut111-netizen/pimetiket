      ...
      <div className="mx-auto max-w-[1280px] px-4 md:px-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 md:gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            {/* Sefa 5 Haz: WhatsApp destek hattı — tek iletişim numarası */}
            <a
              href="https://wa.me/905456999063"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-4 inline-flex items-center gap-2 rounded-full bg-yesil/15 hover:bg-yesil/25 px-3.5 py-2 transition-colors group"
              aria-label="WhatsApp destek hattı: 0545 699 90 63"
            >
              <svg
                width="18"
                height="18"
