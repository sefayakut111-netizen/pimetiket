...
export function YardimPanel({
  ...
  return (
    <>
      {showHeader && (
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-lacivert">Prova Yardımı</h2>
      ...
      {loading ? (
        ...
        <Card className="p-8 text-center">
          ...
          <p className="mt-2 text-[13px] text-gri-700">
            Müşteriler /onay sayfasında &quot;Ekibimizden yardım iste&quot;
            tıkladığında burada görünür.
          </p>
        </Card>
      ) : (
