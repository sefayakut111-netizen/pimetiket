...
const COPY = {
  tr: {
    ...
    pimRole3Desc: "sipariş statüsü, teslim tarihi",
    pimWho3:
  ...
  en: {
    ...
    pimRole3Desc: "order status, delivery dates",
    pimWho3:
      "Just write — I'll figure out the context, or escalate to Sefa if needed.",
