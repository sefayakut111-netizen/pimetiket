...
export default function EtiketConfiguratorError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    Sentry.captureException(error, { tags: { route: "etiket-yapilandir" } });
    console.error("[etiket/yapilandir] Unhandled error:", error);
  }, [error]);
    ...
    <main className="bg-gri-50 animate-fade-up min-h-[calc(100vh-64px)] py-12 flex items-center">
      <div className="mx-auto max-w-[560px] px-6 text-center">
        ...
        <h1 className="mt-3 text-[28px] md:text-[36px] font-semibold tracking-tight leading-tight">
          {isEn ? "Configurator hit a snag" : "Etiket konfigüratörde sorun oluştu"}
        </h1>
        ...
        <div className="mt-7 flex gap-3 justify-center flex-wrap">
          ...
          <Button variant="secondary" size="lg" href="/etiket">
            <Icon.Home size={16} /> {isEn ? "Labels" : "Etiket"}
          </Button>
