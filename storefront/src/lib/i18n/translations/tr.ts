...
export const tr: TranslationDict = {
  ...
  home: {
    ...
    // Sefa 22 May v68 — Yeni 5-adımlı motto sistemi:
    // Başla / Hazırla / Prova / Öde / Kargo — her birinin söylem + duygu eşi
    howItWorksTitle: "5 Adımda Baskıya Hazır.",
    step1: "Başla",
    step1Desc: "Saniyeler içinde başla.",
    step2: "Hazırla",
    step2Desc: "Yükle, gerisini Pim halletsin.",
    step3: "Prova",
    step3Desc: "Basılmadan önce tam gör.",
    step4: "Öde",
    step4Desc: "Beğendin mi? O zaman öde.",
    step5: "Kargo",
    step5Desc: "Kapına kadar gelsin.",
