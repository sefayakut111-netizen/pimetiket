...
export const en: TranslationDict = {
  ...
  home: {
    ...
    // Sefa 22 May v68 — 5-step motto system:
    // Start / Prepare / Proof / Pay / Ship — each with tagline + emotion
    howItWorksTitle: "Print-Ready in 5 Steps.",
    step1: "Start",
    step1Desc: "Get started in seconds.",
    step2: "Prepare",
    step2Desc: "Upload — Pim handles the rest.",
    step3: "Proof",
    step3Desc: "See it fully before it prints.",
    step4: "Pay",
    step4Desc: "Happy with it? Then pay.",
    step5: "Ship",
    step5Desc: "Delivered to your door.",
